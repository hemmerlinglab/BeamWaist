...
data = pd.read_csv("/home/molecules/Desktop/BeamWaist//03252019_inputBeam.csv",header=0)
...
def func(x,w,p,c,d):
	return p/2*(1-erf(sqrt(2)*(x-c)/w))+d
...
popt, pcov = curve_fit(func,microns,voltage,bounds=([10,11.3,10,0],[1300,11.7,800,2]))
print(popt)
print(pcov)
